...
# AlexNet
python main.py --dataset_name "TinyImageNet" --image_size 64 --batch_size 64 --mode "ring" --size 16  --lr 0.01 --model "AlexNet" --warmup_step 300 --milestones 2400 4800 --early_stop 6000 --epoch 6000 --seed 666 --device 0
python main.py --dataset_name "TinyImageNet" --image_size 64 --batch_size 512 --mode "ring" --size 16  --lr 0.08 --model "AlexNet" --warmup_step 300 --milestones 2400 4800 --early_stop 6000 --epoch 6000 --seed 666 --device 0


python main.py --dataset_name "TinyImageNet" --image_size 55 --batch_size 64 --mode "ring" --size 16  --lr 0.04 --model "AlexNet" --warmup_step 0 --milestones 2400 4800 --early_stop 6000 --epoch 6000 --seed 666 --device 0
python main.py --dataset_name "TinyImageNet" --image_size 55 --batch_size 512 --mode "ring" --size 16  --lr 0.32 --model "AlexNet" --warmup_step 0 --milestones 2400 4800 --early_stop 6000 --epoch 6000 --seed 666 --device 0
